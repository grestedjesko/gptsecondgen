...
С подпиской я стану эффективнее в 10 (!) раз
Вам станет доступно
⭐️ 100 запросов к основным нейросетям в день
⭐️ Доступ к умным нейросетям на 10 запросов в день 
⭐️ Обработка запросов голосовыми сообщениями и многое другое  

Нужно больше запросов к умным нейросетям? Можно приобрести пакет запросов""",
...
Давай попробуем!""",
        ...
        "base_subs_text": """Подписка Premium""",
...
<blockquote>⚠️ Переходя на окно оплаты вы подтверждаете ознакомление и согласие с регламентом действия рекуррентных платежей.</blockquote>""",
        ...
        "btn_create_picture": "🖼 Создать изображение",
        "btn_create_video": "🎬 Создать видео",
        "btn_create_music": "🎤 Создать музыку",


        "btn_settings_language": "🌐 Язык",
        "btn_settings_context": "💬 Поддержка контекста",
        "btn_settings_voice": "🎤 Голосовые ответы",
